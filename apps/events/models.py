...
class Event(models.Model):
    ...
    end_date = models.CharField(max_length=10)  # End date of the event
    start_time = models.CharField(max_length=5)  # Start time of the event
    end_time = models.CharField(max_length=5)  # End time of the event
